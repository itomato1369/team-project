...
最も必要とする瞬間に適切な支援を提供できる社会福祉システムを構築しようとしました。
...
| ソースコード管理 | GitHub |
| データベース | MariaDB |
| デプロイ | GitHub Actions, Naver Cloud Platform |
| フロントエンド | Vue.js, Pinia, PrimeVue, HTML, CSS, JavaScript |
...
| KH | GitHub Branch 管理／マイページ／機関ステータス変更 |
