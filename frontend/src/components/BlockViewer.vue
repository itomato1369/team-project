  ...
  <div class="mb-16 overflow-hidden">
    <div class="flex flex-col lg:flex-row justify-between py-4 gap-4 lg:gap-2 px-0!">
      <div class="flex items-center gap-2">
        ...
        <span
          v-if="free"
          class="flex items-center justify-center px-1.5 py-1 w-fit bg-emerald-500 text-emerald-100 dark:bg-emerald-400 dark:text-emerald-800 rounded-md leading-none! text-xs md:text-sm"
          >Free</span
        >
      </div>
      <div class="flex items-center gap-2">
        <!-- Preview/Code Toggle -->
        <div
          class="inline-flex border border-surface-200 dark:border-surface-700 rounded-2xl overflow-hidden min-h-10"
        >
          <button
            :class="[
        ...
        <div class="flex items-center gap-2 grow lg:grow-0 justify-end lg:justify-start">
          ...
          >
            ...
            <span
              :class="[
                'absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 transition-all duration-300 leading-none',
                codeCopyLoading ? 'opacity-100 scale-100 z-10' : 'opacity-0 scale-50 -z-[2]',
              ]"
            >
              <i
                class="pi pi-spinner animate-spin text-surface-700 dark:text-surface-300"
            ...
            <span
              :class="[
                'absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 transition-all duration-300 leading-none',
                codeCopied && !codeCopyLoading
                  ? 'opacity-100 scale-100 z-10'
                  : 'opacity-0 scale-50 -z-[2]',
              ]"
            >
              <svg
                class="w-5 h-5 fill-green-600 dark:fill-green-400"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
              >
                <g id="check">
                  <path
                    d="M9,18.25A.74.74,0,0,1,8.47,18l-5-5A.75.75,0,1,1,4.53,12L9,16.44,19.47,6A.75.75,0,0,1,20.53,7l-11,11A.74.74,0,0,1,9,18.25Z"
                  ></path>
                </g>
              </svg>
            </span>
            ...
            >
              <svg
                class="w-5 h-5 fill-surface-700 dark:fill-surface-300"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
              >
                <g id="clone">
                  ...
                  ></path>
                  <path
                    d="M18,20.75H10A2.75,2.75,0,0,1,7.25,18V16h1.5v2A1.25,1.25,0,0,0,10,19.25h8A1.25,1.25,0,0,0,19.25,18V10A1.25,1.25,0,0,0,18,8.75H16V7.25h2A2.75,2.75,0,0,1,20.75,10v8A2.75,2.75,0,0,1,18,20.75Z"
                  ></path>
                </g>
              </svg>
            </span>
