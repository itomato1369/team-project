...
onBeforeMount(() => {
  userSurveys.value = [
    { id: 'USR-SUR-001', name: '2025년 1분기 만족도 조사', target: '홍길동', status: '작성 가능', deadline: '2025-11-20' },
    { id: 'USR-SUR-002', name: '발달장애인 지원 프로그램 설문', target: '김철수', status: '제출 완료', deadline: '2025-11-10' },
    { id: 'USR-SUR-003', name: '커뮤니티 시설 이용 현황 조사', target: '이영희', status: '작성 가능', deadline: '2025-11-30' },
    { id: 'USR-SUR-004', name: '긴급 돌봄 서비스 수요 조사', target: '박지성', status: '제출 완료', deadline: '2025-10-28' },
  ];
  loading.value = false;
});
