  ...
  <div>
    ...
    >
      <div class="flex flex-col gap-4 items-center sm:items-start justify-center sm:max-w-144">
        <span class="bg-surface-950 text-white px-2 py-1 font-bold rounded-md text-sm"
          >TailwindCSS v4</span
        >
        <div class="flex items-center gap-4">
        ...
        <p class="text-surface-700 dark:text-surface-300 text-lg text-center sm:text-start">
          Ready-to-use UI blocks for building beautiful applications. A comprehensive collection of
    ...
    <BlockViewer header="Hero" :code="blocksCode.hero" free>
      <div
        class="relative min-h-160 lg:min-h-0 bg-surface-0 dark:bg-surface-900 flex lg:flex-row flex-col"
      >
        <div
    ...
    <BlockViewer
      header="Banner"
      :code="blocksCode.banner"
      containerClass="bg-surface-0 dark:bg-surface-950"
      free
    >
    ...
    <BlockViewer header="Page Heading" :code="blocksCode['page-heading']" free>
      <div class="bg-surface-0 dark:bg-surface-950 px-6 py-8 md:px-12 lg:px-20">
        ...
        <div class="flex items-start flex-col md:justify-between md:flex-row">
          <div>
            <div class="font-bold text-3xl text-surface-900 dark:text-surface-0 mb-4">
              Customers
            </div>
            <div class="flex items-center text-surface-700 dark:text-surface-300 flex-wrap gap-8">
              <div class="flex items-center gap-2">
        ...
        <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div class="bg-surface-0 dark:bg-surface-900 shadow-sm p-5 rounded-2xl">
            <div class="flex justify-between gap-4">
              ...
              >
                <i
                  class="pi pi-envelope text-surface-0 dark:text-surface-900 text-xl! leading-none!"
                />
              </div>
            </div>
            <div class="mt-4">
              <span class="text-surface-600 dark:text-surface-300 font-medium leading-tight"
                >24 new</span
              >
